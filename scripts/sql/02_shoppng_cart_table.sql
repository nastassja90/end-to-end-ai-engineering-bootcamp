-- Connect to the tools_database to create the shopping_cart_items table
\c tools_database
...
CREATE INDEX idx_shopping_cart_user_cart ON shopping_cart_items(user_id, shopping_cart_id);

-- Index for faster queries by user
CREATE INDEX idx_shopping_cart_user_id ON shopping_cart_items(user_id);

-- Index for faster queries by product
CREATE INDEX idx_shopping_cart_product_id ON shopping_cart_items(product_id);
