...
```Markdown
Downloads -> Choose your OS -> Download the latest stable version -> Run the installer
```
...
It should show python version that is currently being used.
...
[uv](https://github.com/astral-sh/uv) is a Python package manager written in Rust. It is faster than pip and comes with additional project management capabilities. I highly recommend trying it out if you have not done so yet.
...
To bootstrap the initial files required by uv Python project management:
